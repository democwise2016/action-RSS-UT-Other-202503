...
https://democwise2016.github.io/action-RSS-UT-Other-202503/
...
````bash
git clone --branch main --single-branch --depth 1 https://github.com/democwise2016/action-RSS-UT-Other-202503.git
````